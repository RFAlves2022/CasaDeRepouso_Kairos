    ...
    <div class="page-card">
      <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
          ...
          <p class="page-header-sub mb-0">
            Registre dados pessoais, contato, quarto, responsável e foto do residente.
          </p>
        </div>
      ...
      <div class="page-body">
        <?php if (isset($_GET['sucesso'])): ?>
          <div class="alert alert-success" role="alert">Residente cadastrado com sucesso!</div>
        <?php endif; ?>

        <?php if (isset($cadastro_erro)): ?>
          <div class="alert alert-danger" role="alert"><?= htmlspecialchars($cadastro_erro) ?></div>
        <?php endif; ?>

        <form action="cadastrarResidente.php" method="POST" enctype="multipart/form-data" class="mx-auto" style="max-width: 880px;">
          ...
          <div class="mb-4 photo-box">
            <label for="foto" class="form-label d-block">Foto do residente</label>
            <div class="d-flex flex-column flex-md-row align-items-md-center gap-3">
              <img id="fotoPreview" src="https://via.placeholder.com/120x120?text=Foto" alt="Preview da foto" class="photo-preview">
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-pill-primary mt-2 mb-3 px-5">
              Cadastrar residente
            </button>
          </div>
        </form>
...
<script>
  ...
  fotoInput.addEventListener('change', function () {
    ...
    if (!file) {
      fotoPreview.src = 'https://via.placeholder.com/120x120?text=Foto';
      return;
    }
